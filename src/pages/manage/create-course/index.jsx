            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col w-[550px] rounded-[30px] p-[30px] gap-[30px] bg-[#F8FAFB]">
                <div className="flex flex-col gap-[10px]">
                    ...
                    <div className="flex items-center w-full rounded-full border border-[#CFDBEF] gap-3 px-5 transition-all duration-300 focus-within:ring-2 focus-within:ring-[#662FFF]">
                        ...
                        <input
                            {...register('name')}
                            type="text" id="title" className="appearance-none outline-none w-full py-3 font-semibold placeholder:font-normal placeholder:text-[#838C9D] bg-transparent" placeholder="Write better name for your course" />
                    </div>
                ...
                <div className="relative flex flex-col gap-[10px]">
                    ...
                    <div id="thumbnail-preview-container" className="relative flex shrink-0 w-full h-[200px] rounded-[20px] border border-[#CFDBEF] overflow-hidden">
                        ...
                        }} type="button" id="trigger-input" className="absolute top-0 left-0 w-full h-full flex justify-center items-center gap-3 z-0">
                    ...
                    />
                    <span className="error-message text-[#FF435A]">{errors.thumbnail?.message}</span>
                ...
                <div className="flex flex-col gap-[10px]">
                    ...
                    <div className="flex w-full rounded-[20px] border border-[#CFDBEF] gap-3 p-5 transition-all duration-300 focus-within:ring-2 focus-within:ring-[#662FFF]">
                        ...
                        <textarea {...register('description')} id="desc" rows="5" className="appearance-none outline-none w-full font-semibold placeholder:font-normal placeholder:text-[#838C9D] bg-transparent" placeholder="Explain what this course is about"></textarea>
                    </div>
                    <span className="error-message text-[#FF435A]">{errors.tagline?.message}</span>
                </div>
