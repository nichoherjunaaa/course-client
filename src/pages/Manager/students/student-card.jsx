                ...
                <div className="w-full">
                    ...
                    <div className="flex items-center gap-5">
                        <div className="flex items-center gap-[6px] mt-[6px]">
                            ...
                            <p className="text-[#838C9D]">{totalCourse}</p>
                        </div>
                    </div>
                </div>
                <div className="flex justify-end items-center gap-3">
                    <Link to={`/manager/student/edit/${id}`} className="w-fit rounded-full border border-[#060A23] p-[14px_20px] font-semibold text-nowrap">
                        Edit Profile
                    </Link>
                    <button type="button" className="w-fit rounded-full p-[14px_20px] bg-[#FF435A] font-semibold text-white text-nowrap">
                        Delete
                    </button>
                </div>
            </div>
